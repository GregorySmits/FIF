...
class Displayer:
    ...
    def __init__(self, precC, precF, rapC, rapF, fmC, fmF, eC, eF, timeC, timeF, aucC, aucF):
        ...
        ax[5].set_title("TIME (FUZZY is plain, CRISP is dashed) log")
